INSERT INTO public.negocio(codnegocio, contribuyente, direccion, email, imagen, mascaracontable, nombre, habilitado, telefono, telefonomovil, web, cantidadusuario, tiempocierresesion, dominio, ip, puerto) VALUES ('406080195', 'Si', 'Carrera 58B # 58 P-22', '', '', '', 'Nk-System Consultores', true, '', '', '', 3, 15, '', '', 0);
...
insert into tipodocumento(nombre,codnegocio,status,nombrelogicodocumento)values('Factura de Venta', 1,'ACTIVO','factura');
insert into tipodocumento(nombre,codnegocio,status,nombrelogicodocumento)values('Nota de Credito', 1,'ACTIVO','notacreditoventas');
insert into tipodocumento(nombre,codnegocio,status,nombrelogicodocumento)values('Nota de Debito', 1,'ACTIVO','notadebitoventas');
