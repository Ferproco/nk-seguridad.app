...
insert into marca(nommarca,codnegocio,status) values('Ninguna',1,'ACTIVO');
...
insert into tipodocumento(nombre,codnegocio,status)values('Factura de Venta', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Nota de Credito', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Nota de Debito', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Recibo de Caja', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Comprabante de Caja', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Cotizacion', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Orden de Compra', 1,'ACTIVO');
insert into tipodocumento(nombre,codnegocio,status)values('Remision',1,'ACTIVO');
