...
@Entity
@Table(name = "movimientoscxc",schema = "public")
public class MovimientosCxC implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5167529211428108064L;
