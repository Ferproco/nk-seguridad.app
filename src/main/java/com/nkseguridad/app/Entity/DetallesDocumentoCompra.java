...
@Entity
@Table(name="detallesdocumentocompra",schema="public")
public class DetallesDocumentoCompra implements Serializable {
    ...
    private Long coddocumentocompra;
	...
	@ManyToOne
	@JoinColumn(name = "coddocumentocompra", insertable = false, updatable = false)
	...
	public Long getCoddocumentocompra() {
		return coddocumentocompra;
	}

	public void setCoddocumentocompra(Long coddocumentocompra) {
		this.coddocumentocompra = coddocumentocompra;
	}
